...
set_output_delay -clock sd1clk_pin -min 0 [get_ports DRAM_CLK]
...
set_multicycle_path -from {SDRAMTest:mySDRAMTest|SDRAMTest_ROM:myrom|altsyncram:ram_rtl_0|altsyncram_5cs1:auto_generated|*} -to {SDRAMTest:mySDRAMTest|zpu_core:zpu|*} -hold -end 2
set_multicycle_path -from {SDRAMTest:mySDRAMTest|SDRAMTest_ROM:myrom|altsyncram:ram_rtl_0|altsyncram_5cs1:auto_generated|*} -to {SDRAMTest:mySDRAMTest|zpu_core:zpu|*} -setup -end 2
