...
derive_pll_clocks 
create_generated_clock -name sd1clk_pin -source [get_pins {MyPLL|altpll_component|auto_generated|pll1|clk[1]}] [get_ports {SDRAM_CLK}]
create_generated_clock -name sysclk -source [get_pins {MyPLL|altpll_component|auto_generated|pll1|clk[0]}]
...
set_multicycle_path -from {SDRAMTest:mySDRAMTest|SDRAMTest_ROM:myrom|altsyncram:ram_rtl_0|altsyncram_ngs1:auto_generated|*} -to {SDRAMTest:mySDRAMTest|zpu_core:zpu|*} -setup -end 2
set_multicycle_path -from {SDRAMTest:mySDRAMTest|SDRAMTest_ROM:myrom|altsyncram:ram_rtl_0|altsyncram_ngs1:auto_generated|*} -to {SDRAMTest:mySDRAMTest|zpu_core:zpu|*} -hold -end 2
